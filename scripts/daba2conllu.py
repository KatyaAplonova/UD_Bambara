...
#	part of speech tags
	...
	if pos == 'pm':
		tags[0] = 'AUX'
	if pos == 'conj' and lem in ["bàri", "jàa", "jàga", "kélen", "kòni", "nká", "ǹka", "nk'", "ô", "ôo", "wô", "tàrí", "tɛ̀rí", "wà", "wáa", "w'", "wálà", "wàlámà", "wàlímà", "wáli", "wó", "àni",  "àní", "àn'", "àní", "wálìma", "wá", "bári", "tàri", "nɔ́ntɛ́", "an'", "ń'ó ntɛ́", "ngá", "nɔ́ntɛ̀", "ó`", "epi", "ń'ò ntɛ́", "nk", "Nk'", "ńka", "nóntɛ̀", "ò", "tɛ́ri", "wa", "wál'"]:
		tags[0] = 'CCONJ'
	if pos == 'conj' and lem in ["bárì", "bárìsá", "bárì sá", "báwò", "bɛ́ɛ", "bína", "bíɲa", "dàma", "dɔ́rɔn", "fó", "jànkó", "jàngó", "kàsɔrɔ", "kàtugu", "kàtuguni", "kɔ́ntɛ̀", "mînkɛ́", "mînkɛ́ni", "ní", "ni", "n'ó tɛ́","n'", "nóntɛ́", "nɔ́ntɛ", "sá", "sábu", "sáabu", "sábi", "sábula", "sàfɛ", "sáni", "sánì", "sánni", "sánnì", "sán'", "sánn'", "sànkó", "sàngó", "tɛ́sɛ", "tílen", "wálasa", "wáasa", "wálisa", "yáa", "yála", "yálasa", "yáasa", "yála", "yálisa", "jáasa", "yànni", "yànn'", "yàli", "kàbini", "fɔ́", "kómi", "bárisa", "f'", "mínkɛ", "yànní", "kàbi", "ínafɔ", "íko", "paseke", "íkomi", "kómin", "n", "kàbin'", "N'", "kàbii", "mínkɛni", "bárisigi", "fɔ́ɔ", "hákàjá", "múnkɛ", "tɛ̀ri", "báwu", "Ni", "Ní", "́ní", "ȉko", "ikomi", "ikomin", "kómì", "kɔ́mì", "́múnkɛ", "nì", "san'", "sann'", "wása", "yani"]:
		tags[0] = 'SCONJ'
